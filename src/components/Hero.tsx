...
export const Hero = () => {
  return (
    <div className="flex flex-col items-center mt-[100px] md:mt-[150px] lg:mt-[200px]">
      <h1 className="text-4xl md:text-5xl font-bold leading-tight lg:text-6xl w-[70%]  text-center">
      ...
      <div className="w-full h-[37vh] md:h-[49vh] lg:h-screen relative flex items-center justify-center overflow-hidden mt-42">
        {/* Background Video */}
        <video
          autoPlay
          loop
