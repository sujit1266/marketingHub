...
export function Video({ videoId }: Readonly<VideoProps>) {
  ...
  return (
    <Container>
      <div className="relative w-full h-[700px] max-w-8xl mx-auto overflow-hidden lg:mb-20 rounded-2xl cursor-pointer bg-black">
        {/* {!playVideo && (
          <button
        ...
        <div className="form-wrapper absolute top-[10px] right-[6%] md:right-24 rounded-3xl">
