...
const ReachUsForm: React.FC = () => {
  ...
  return (
    <PrimeReactProvider>
      <form onSubmit={handleSubmit} className="w-full max-w-lg mx-auto p-6 sm:p-10">
  ...
  <div className="mb-4">
    <input
      ...
      placeholder='Name'
      className="mt-1 block w-full pr-[2rem] sm:pr-[15rem] py-4 border border-gray-300 shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 bg-[transparent] rounded-2xl text-[#000]"
    />
  ...
  <div className="mb-4">
    <input
      ...
      className="mt-1 block w-full pr-[2rem] sm:pr-[15rem] py-4 border border-gray-300 shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 bg-[transparent] rounded-2xl text-[#000]"
    />
    {errors.companyName && <p className="text-[#000] text-sm mt-1">{errors.companyName}</p>}
  </div>
  ...
  <div className="mb-4">
    <input
      ...
      className="mt-1 block w-full pr-[2rem] sm:pr-[15rem] py-4 border border-gray-300 shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 bg-[transparent] rounded-2xl text-[#000]"
    />
    {errors.service && <p className="text-[#000] text-sm mt-1">{errors.service}</p>}
  </div>
