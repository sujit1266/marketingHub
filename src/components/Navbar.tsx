...
export const Navbar = () => {
  ...
  const servicesDropdown = [
    ...
    { label: "Pay-Per-Click Adver sing", to: "/services/ppc" },
  ...
  return (
    <div className={`w-full fixed z-[999] bg-[rgba(255,255,255,1)] px-10`}>
      <nav className="relative flex flex-wrap items-center justify-between py-4 sm:p-4 lg:justify-between xl:px-1 z-[999] h-[max-content]">
        {/* Logo  */}
        <Link href="/">
          <span className="flex items-center space-x-2 text-2xl font-medium text-indigo-500 dark:text-gray-100">
            <span>
              <Image
                ...
                alt="N"
                height="2000"
                className="w-[200px] sm:w-60 md:w-80"
              />
            </span>
          </span>
        </Link>
